...
cdef extern from *:     # PARI headers already included by types.pxd
    ...
    char  *stack_malloc_align(size_t N, long k)
    ...
    long   varnmax(long x, long y)
    long   varnmin(long x, long y)
    ...
    GEN    bid_get_archp(GEN bid)
    GEN    bid_get_cyc(GEN bid)
    GEN    bid_get_fact(GEN bid)
    ...
    GEN    bid_get_sarch(GEN bid)
    GEN    bid_get_sprk(GEN bid)
    ...
    long   logint(GEN B, GEN y)
    ulong  ulogint(ulong B, ulong y)
    ...
    ulong  upr_norm(GEN pr)
    GEN    znstar_get_N(GEN G)
    GEN    znstar_get_conreycyc(GEN G)
    GEN    znstar_get_conreygen(GEN G)
    GEN    znstar_get_faN(GEN G)
    GEN    znstar_get_no(GEN G)
    ...
    GEN    FqX_factor(GEN f, GEN T, GEN p)
    GEN    FqX_gcd(GEN P, GEN Q, GEN T, GEN p)
    GEN    FqX_get_red(GEN S, GEN T, GEN p)
    GEN    FqX_halfgcd(GEN P, GEN Q, GEN T, GEN p)
    ...
    long   get_F2x_degree(GEN T)
    GEN    get_F2x_mod(GEN T)
    long   get_F2x_var(GEN T)
    long   get_F2xqX_degree(GEN T)
    GEN    get_F2xqX_mod(GEN T)
    long   get_F2xqX_var(GEN T)
    long   get_Flx_degree(GEN T)
    GEN    get_Flx_mod(GEN T)
    long   get_Flx_var(GEN T)
    long   get_FlxqX_degree(GEN T)
    ...
    void   Qtoss(GEN q, long *n, long *d)
    GEN    R_abs(GEN x)
    GEN    R_abs_shallow(GEN x)
    ...
    GEN    pol_1(long v)
    GEN    pol_x(long v)
    GEN    pol_xn(long n, long v)
    GEN    pol_xnall(long n, long v)
    ...
    void   pari_err_COMPONENT(const char *f, const char *op, GEN l, GEN x)
    ...
    void   pari_err_INV(const char *f, GEN x)
    ...
    void   pari_err_PACKAGE(const char *f)
